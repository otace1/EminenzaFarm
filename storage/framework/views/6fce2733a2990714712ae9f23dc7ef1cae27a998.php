...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.buttons.plain','data' => ['bgColor' => 'bg-primary-500','wireClick' => '$emit(\'newTab\', \''.e(route('tags.link',$model->id)).'\' ) ']]); ?>
...
</div><?php /**PATH /Users/ambrosetemidayobako/Desktop/Dev/web/fuodz-admin/resources/views/components/buttons/tag_actions.blade.php ENDPATH**/ ?>